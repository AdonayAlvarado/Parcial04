                  ...
                  itemBuilder: ((context, index) {
                    ...
                    return Dismissible(
                      confirmDismiss: (direction) async {
                        ...
                        eliminar(snapshot.data?[index]['id'], 'MD_Cliente');
                        return true;
                      },
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          await Navigator.pushNamed(context, '/edit',
                              arguments: {
                                'ID_Cliente': snapshot.data?[index]
                                    ['ID_Cliente'],
                                'sNombreCliente': snapshot.data?[index]
                                    ['sNombreCliente'],
                                'sApellidosCliente': snapshot.data?[index]
                                    ['sApellidosCliente'],
                                'sDireccionCliente': snapshot.data?[index]
                                    ['sDireccionCliente'],
                                'sCiudadCliente': snapshot.data?[index]
                                    ['sCiudadCliente'],
